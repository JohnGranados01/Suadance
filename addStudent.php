...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2><span>Sistema de control de asistencia y registro de estudiantes SDC</span></h2>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link" href="#add">Registrar estudiante</a></li>
          <li><a class="nav-link" href="listStudent.php">Lista de Estudiantes</a></li>
          <li><a class="nav-link" href="#resume">Horarios y Clases</a></li>
